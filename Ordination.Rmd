...
plot1<-ggplot(site_scores1)+
  ...
  xlab("CAP1 [8.7%]") +  # 
  ylab("CAP2 [4.5%]") +  # 
  ggplot2::annotate("text",x=1.3,y=3.1,label="Community *\nSite         NS\nCommunity*Site NS", size = 3)+
  expand_limits(x=2.5,y = 3.6)+
...
plot2<-ggplot(site_scores2)+
  ...
  xlab("CAP1 [8.5%]") +  # 
  ylab("CAP2 [4.7%]") +  # 
  ggplot2::annotate("text",x=1.4,y=2.5,label="Community *\nSite        NS\nCommunity*Site NS", size = 3)+
...
ord3 <- plot_grid(plot1, plot2, plot2m, nrow = 1, labels=c("A. Composition","B. MPD", "C. MNTD"),label_fontface = "plain",hjust=c(-.4,-0.8),vjust=1,rel_widths = c(1.4,2))
