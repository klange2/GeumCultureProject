...
shan_site <- summary(aov(data_shannon ~ Site, data = data_alphadiv))
...
shan_comsite <- summary(aov(data_shannon ~ Community_Site, data = data_alphadiv))   
...
summary(aov(S.chao1 ~ Site, data = data_alphadiv))
...
summary(aov(data_simpson ~ Site, data = data_alphadiv))
