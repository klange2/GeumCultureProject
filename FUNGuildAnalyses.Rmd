...
ggsave("plantpathogen.png",funp4)
...
ggsave("symbiotroph.png",funsym5)
...
funsap5 <- ggplot(dat7,aes(x=Community.x,y=saprotrophbroadprobablehptaxapercent,color=Community.x,group=Community.x))+
    geom_boxplot()+
  geom_point()+
  ggplot2::annotate("text", x = 1, y = 110, label = "c", color = "black")+
  ggplot2::annotate("text", x = 2, y = 110, label = "a", color = "black")+
  ggplot2::annotate("text", x = 3, y = 85, label = "bc", color = "black")+
  ggplot2::annotate("text", x = 4, y = 110, label = "ab", color = "black")+
  labs(x = "",y="Saprotroph",tag="C") +
  scale_y_continuous(breaks = c(0, 20, 40, 60, 80, 100))+
  theme_classic()+
  theme(line=element_line(linewidth=.3),text=element_text(size=12),strip.background = element_rect(colour="white", fill="white"),axis.line=element_line(color="gray30",linewidth=.5),legend.position = "none",strip.placement = "outside",panel.spacing=unit(0,"cm"),axis.text.x = element_text(angle = 45, vjust = 1, hjust=1),panel.background = element_rect(fill = NA, color = "gray50"))

ggsave("saprotroph.png",funsap5)
...
ggsave("plantsaprotroph.png",funsap4)
...
trop2 <- plot_grid(funsym5, funp9, funsap5,funer5, ncol = 2, nrow = 2)
ggsave("functionplot.png",trop2)
...
#tukey
tuk_sap = aov(saprotrophbroadprobablehptaxapercent ~ Community.x, data = dat7)
summary(tuk_sap)
