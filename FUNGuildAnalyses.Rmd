...
#pathotroph
m1p<-lme(pathotrophtaxapercent~Community.x*Site,random=~1|PlantIndividual,data=dat7,na.action=na.omit)
...
m2sap<-gls(saprotrophtaxapercent~Community.x+Site,data=dat7,na.action=na.omit)
