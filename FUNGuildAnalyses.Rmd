...
anova(m6p)
m7p<-gls(pathotrophbroadprobablehptaxapercent~Community.x*Site,data=dat7,na.action=na.omit)
anova(m7p,type="marginal")
hist(resid(m7p))
boxplot(resid(m7p)~dat7$CommunitySitePL)
m8p<-gls(pathotrophbroadprobablehptaxapercent~Site*Community.x,data=dat7,na.action=na.omit)
anova(m8p,type="marginal")
