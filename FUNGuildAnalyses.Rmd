...
#plant pathogen
m1p<-gls(plantpathogentaxapercent~Community.x*Site,data=dat7,na.action=na.omit)
anova(m1p,type="marginal")
hist(resid(m1p))
boxplot(resid(m1p)~dat7$CommunitySitePL)
m2p<-gls(plantpathogenbroadprobablehptaxapercent~Community.x*Site,data=dat7,na.action=na.omit)
anova(m2p,type="marginal")
hist(resid(m2p))
boxplot(resid(m2p)~dat7$CommunitySitePL)

#pathotroph
m3p<-gls(pathotrophtaxapercent~Community.x*Site,data=dat7,na.action=na.omit)
anova(m3p,type="marginal")
hist(resid(m3p))
boxplot(resid(m3p)~dat7$CommunitySitePL)
m4p<-gls(pathotrophbroadprobablehptaxapercent~Community.x*Site,data=dat7,na.action=na.omit)
anova(m4p,type="marginal")
hist(resid(m4p))
boxplot(resid(m4p)~dat7$CommunitySitePL)

#ericoid
m1e<-gls(ericoidtaxapercent~Community.x*Site,data=dat7,na.action=na.omit)
anova(m1e,type="marginal")
hist(resid(m1e,type="marginal"))
boxplot(resid(m1e)~dat7$CommunitySitePL)
m2e<-gls(ericoidbroadprobablehptaxapercent~Community.x*Site,data=dat7,na.action=na.omit)
anova(m2e)
hist(resid(m2e,type="marginal"))
boxplot(resid(m2e)~dat7$CommunitySitePL)

#symbiotroph
m1sym<-gls(symbiotrophtaxapercent~Community.x*Site,data=dat7,na.action=na.omit)
...
hist(resid(m2sym))
boxplot(resid(m2sym)~dat7$CommunitySitePL)

#saprotroph
m1sap<-gls(saprotrophtaxapercent~Community.x*Site,data=dat7,na.action=na.omit)
...
hist(resid(m2sap))
boxplot(resid(m2sap)~dat7$CommunitySitePL)

#plant saprotroph
m1psap<-gls(plantsaprotrophtaxapercent~Community.x*Site,data=dat7,na.action=na.omit)
anova(m1psap,type="marginal")
hist(resid(m1psap))
boxplot(resid(m1psap)~dat7$CommunitySitePL)
m2psap<-gls(plantsaprotrophbroadprobablehptaxapercent~Community.x*Site,data=dat7,na.action=na.omit)
anova(m2psap,type="marginal")
hist(resid(m2psap))
boxplot(resid(m2psap)~dat7$CommunitySitePL)

#endophyte
m1end<-gls(endophytetaxapercent~Community.x*Site,data=dat7,na.action=na.omit)
anova(m1end,type="marginal")
hist(resid(m1end))
boxplot(resid(m1end)~dat7$CommunitySitePL)
m2end<-gls(endophytebroadprobablehptaxapercent~Community.x*Site,data=dat7,na.action=na.omit)
anova(m2end,type="marginal")
hist(resid(m2end))
boxplot(resid(m2end)~dat7$CommunitySitePL)
