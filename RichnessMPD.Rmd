...
``` {r}
m1<-lme(data_evenness~Community*Site,random=~1|Community_Site,data=data_alphadiv,na.action=na.omit)
anova(m1,type="marginal")
#statistically different
...
##Stats
``` {r}
m1<-lme(data_shannon~Community*Site,random=~1|Community_Site,data=data_alphadiv,na.action=na.omit)
anova(m1,type="marginal")
#statistically different
...
m1<-lme(mntd.obs.z.weighted~Community.x*Site,random=~1|PlantIndividual,data=dat6,na.action=na.omit)
anova(m1,type="marginal")
